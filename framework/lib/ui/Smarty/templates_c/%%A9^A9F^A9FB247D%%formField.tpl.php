<?php /* Smarty version 2.6.18, created on 2010-04-28 11:21:23
         compiled from formField.tpl */ ?>
<?php if ($this->_tpl_vars['field'] instanceof formField): ?>
	<?php ob_start(); ?><?php echo get_class($this->_tpl_vars['field']) . '.tpl'; ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('template', ob_get_contents());ob_end_clean(); ?>
