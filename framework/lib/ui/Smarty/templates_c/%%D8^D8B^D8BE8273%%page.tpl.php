<?php /* Smarty version 2.6.18, created on 2010-08-31 13:55:20
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="nl" lang="nl">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="highslide/highslide.css" />
     	...
     	<?php echo $this->_tpl_vars['rteheader']; ?>
	...
	<body onLoad="xajax_initpage();dhtmlHistoryInit();">
		...
		<div id="topbarright">
			<div class="paddingcontainer">
				<?php echo $this->_tpl_vars['top_expand']; ?>
&nbsp;
			</div>
		</div>
		<div id="mainbar">
		<div id="first_level_menu">
			<?php echo $this->_tpl_vars['first_level_menu']; ?>

		</div>
			<table id="maintable">
				<tr>
					<td id="leftcol">
						<?php echo $this->_tpl_vars['leftcol']; ?>
