...
Om het normale verkeer naar het ziekenhuis (ziekenwagens, artsen, personeel en bezoekers) in goede banen te leiden hebben we voor die dag de <strong>parking IDM, Zelebaan 42, Lokeren</strong> exclusief gereserveerd voor bezoekers aan de OBD.  Een <strong>pendelbusverbinding</strong> naar het ziekenhuis is voorzien.  Voorzie best een korte tijdsmarge tussen aankomst op de parking en de start van het gekozen traject, zoals hieronder beschreven.
<br />
<br />
