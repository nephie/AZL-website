...
if($tinybrowser['allowupload'])
	{
	?><li id="upload_tab"><span><a href="<?php echo $uploadpathhack; ?>/upload.php?normalpath=<?php echo $normalpathhack; ?>&type=<?php echo $typenow.$passfolder.$passfeid; ?>"><?php echo TB_UPLOAD; ?></a></span></li><?php
	}
